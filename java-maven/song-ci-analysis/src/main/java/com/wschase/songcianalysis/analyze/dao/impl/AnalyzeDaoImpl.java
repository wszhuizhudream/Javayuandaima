package com.wschase.songcianalysis.analyze.dao.impl;
...
public class AnalyzeDaoImpl implements AnalyzeDao {
    ...
    public List<AuthorCount> analyzeAuthorCount() {
        ...
        String sql="select count(*) as count ,author from songci_info group by author;";
    ...
    @Override
    public List<SongCiInfo> queryAllPoetryInfo() {
        List<SongCiInfo> datas=new ArrayList<>();
        //因为sql语句短，所以我们可以直接将sql语句定义在外面
        String sql=" select title,dynasty,author,content from songci_info;";
